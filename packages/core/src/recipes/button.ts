...
/**
 * Button variant recipe — the single source of truth for Button's Tailwind
...
/**
 * Wrapper-structural utilities used by Button's icon slots. Exported from core
 * (rather than hand-written in each framework wrapper) so their literals are
 * scanned into the shipped stylesheet.
 */
export const iconSlotClass = "contents";
